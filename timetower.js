javascript:
    if (document.URL.match("mode=incomings&subtype=attacks")) {
        ...
        function first() {
            $.ajax({
                ...
                success: function(data) {
                    $.each(["espada", "machado", "explorador", "leve", "pesada", "aríete", "nobre"], function(key, val) {
                        // extract unit speeds
        ...
        var doStuff = function() {
            ...
            } else if (commandName.includes("machado") || commandName.includes("spear")) {
            ...
            } else if (commandName.includes("cavl") || commandName.includes("light")) {
                var remainingFields = seconds / unitSpeed[3];
            } else if (commandName.includes("cavp") || commandName.includes("heavy")) {
            ...
            }else if (commandName.includes("nobre") || commandName.includes("snob")) {
